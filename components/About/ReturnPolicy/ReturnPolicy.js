...
export default function ReturnPolicy() {
  ...
  return (
    <div>
      <header>WHAT IS Project_Y's RETURN POLICY?</header>
      <article>
        ...
        <p>
          <b>
            ...
            receive your items, we’ll process your return and issue a
      ...
      <section>
        <h3>OTHER TERMS</h3>
        <p>
          While shopping in store, you may have the option of shipping
          an item to a store to pick up. If you are unable to pick up
          the order within 30 days, we will return your order and
          issue a refund to your original form of payment.
        </p>
        <p>
          We reserve the right to require and electronically capture
          consumer information from a valid state or government ID for
          all returns/exchanges. We maintain a database of consumer
          return activity created solely for the purpose of
